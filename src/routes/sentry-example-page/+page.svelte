...
<div>
  <main>
    ...
    <p class="description">
      Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://romewithme.sentry.io/issues/?project=4509991069548544">Issues Page</a>. 
